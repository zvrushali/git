                                    ...
                                    <div class="tab-pane active" id="tab_0" style="margin-top: -30px;">
                                        <div class="portlet box green" style="margin:0 100px">
                                            ...
                                            <div class="portlet-body form">
                                                <!-- BEGIN FORM-->
                                                <form action="{{url('/edit_question_insert/'.$qus->id)}}" class="form-horizontal" method="post">
                                                    {{ csrf_field() }}
                                                    <div class="form-body">
                                                           ...
                                                           <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                               <span class="input-group-addon input-circle-left {{ $errors->has('question') ? 'has-error' :'' }}">
                                                                    ...
                                                                    <textarea class="form-control  input-circle-right {{ $errors->has('question') ? 'has-error' :'' }}" placeholder="Question" name="question">{{$qus->questions}}</textarea>
                                                                                                                                    </div>
                                                         ...
                                                         <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                               <span class="input-group-addon  input-circle-left {{ $errors->has('option1') ? 'has-error' :'' }}">
                                                                    ...
                                                                    <input  id="option1" type="text" class="form-control input-circle-right {{ $errors->has('option1') ? 'has-error' :'' }}" placeholder="Option 1" name="option1" value="{{$qus->option1}}">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-7">
                                                                <div class="input-group">
                                                                    ...
                                                                    <input id="option2" type="text" class="form-control input-circle-right {{ $errors->has('option2') ? 'has-error' :'' }}" placeholder="Option 2" name="option2" value="{{$qus->option2}}">
                                                                </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-7">
                                                                <div class="input-group">
                                                                    ...
                                                                    <input id="option3"  type="text" class="form-control input-circle-right {{ $errors->has('option3') ? 'has-error' :'' }}" placeholder="Option 3" name="option3" value="{{$qus->option3}}">
                                                       ...
                                                       <div class="form-group">
                                                            ...
                                                            <div class="col-md-7">
                                                                <div class="input-group">
                                                                    ...
                                                                    <input id="option4" type="text" class="form-control input-circle-right {{ $errors->has('option4') ? 'has-error' :'' }}" placeholder="Option 4" name="option4" value="{{$qus->option4}}">
                                                            ...
                                                            <div class="col-md-7">
                                                                <div class="input-group">
                                                                    <span class="input-group-addon input-circle-left {{ $errors->has('ans') ? 'has-error' :'' }}">
                                                                      ...
                                                                      <input id="ans" type="text" class="form-control input-circle-right {{ $errors->has('ans') ? 'has-error' :'' }}" value="{{$qus->correct_ans}}" placeholder="Correct Answer" name="ans" readonly>
